...
class FirewallMonitor:
    ...
    Args:
        ...
        mgmt_ips:       Dict mapping container name → management IP
    ...
    def _check_ssh(self, ip: str) -> bool:
        """Try to TCP connect to port 22 of the management IP."""
        import socket
        try:
    ...
    def check_node(self, container: str) -> NodeStatus:
        ...
        # SSH
        mgmt_ip = self.FW_MGMT_IPS.get(container, "")
        if mgmt_ip:
            status.ssh_reachable = self._check_ssh(mgmt_ip)
