...
| Member 3 | Shahzod           | CI/CD and Delivery Structure                 | Responsible for designing and improving the CI/CD workflow, defining the Gitea/GitLab-based repository structure, supporting project organization, and validating the final project version to ensure system reliability and successful deployment. |
